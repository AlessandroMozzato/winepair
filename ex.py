...
path = '/Users/am8e13/wine-data/Wine-Food-Pairing-Algorithm/'
# Read the databases that I currently have
wineDatabase = open(path+'winelist', 'r');
database = open(path+'database', 'r');
wineToFlavor = open(path+'winetoflavor', 'r');
wineToDinner = open(path+'winetodinner', 'r');
